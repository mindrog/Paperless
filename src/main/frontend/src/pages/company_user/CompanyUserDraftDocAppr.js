...
function CompanyUserDraftDocAppr() {
    ...
    const completedColumns = [
      ...
      { key: 'approvalDate', label: '결재일', width: '15%' }, // 추가된 컬럼
    ...
    const generateDocs = () => {
      ...
      for (let i = 1; i <= 30; i++) {
        docList.push({
          ...
          approvalDate: `2024-10-${String(i).padStart(2, '0')}`,
          status: '결재 완료',
        });
      }
      return docList;
...
export default CompanyUserDraftDocAppr